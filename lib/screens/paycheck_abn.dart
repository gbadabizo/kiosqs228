...
class PayCheckAbn extends StatefulWidget {
 final String codetrans;

 PayCheckAbn({this.codetrans});

 @override
  _PayCheckAbnState createState() => _PayCheckAbnState();
}

class _PayCheckAbnState extends State<PayCheckAbn> {
  ...
  checkpay2() async {
    ...
    Reponse rep = await kiosqsService.checkPayAbn(widget.codetrans);
    print(rep.toString());
    if (rep != null) {
      if (rep.code == "0") {
        showToast("Le paiement  effectué avec succès",
